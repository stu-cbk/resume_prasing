...
def main():
    ...
    ## Required parameters
    parser.add_argument("--train_file", default="./Resume命名实体识别数据集/train.txt", type=str)
    parser.add_argument("--eval_file", default="./Resume命名实体识别数据集/dev.txt", type=str)
    parser.add_argument("--test_file", default="./Resume命名实体识别数据集/test.txt", type=str)
    parser.add_argument("--model_name_or_path", default="./huggingface/bert-base-chinese", type=str)
