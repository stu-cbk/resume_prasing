<template>
  <div class="content">
    <div class="upload">
      ...
      >
        <div class="el-upload__text"><em>多文件上传</em></div>
...
export default {
  data() {
    return {
      uploadUrl: "http://localhost:5000/multiData/upload",
      detail: "",
      turnTar: false,
      progress: 0,
    };
  ...
  methods: {
    ...
    callApi() {
      if (this.turnTar) {
        ...
        axios
          .post("http://localhost:5000/multiData/dealFile", {}, {
          ...
          .then((response) => {
            ...
            return axios
              .post(
                "http://localhost:8181/api/resume/classifyMultiResume",
                this.detail,
                {
                  headers: {
